...
### 1. 📖 200 篇 CEFR 欧标梯度分级精读文库 (200 Graded Reading Lessons)
* **A1 - B2 梯度全覆盖**：严格遵循欧洲语言共同参考框架（CEFR），从 A1 零基础日常对话循序渐进至 B2 深度文学与文化叙事；
* **丰富多元的主题语料**：涵盖马德里市井生活、巴特罗之家与高迪建筑艺术、塞维利亚四月节民俗、地中海饮食哲学、《百年孤独》魔幻现实主义文学等数十种真实生动的文化场景；
* **极简聚焦与防疲劳轮转**：支持按等级即时筛选，采用卡片批次轮转机制（默认聚焦展示 8 篇，支持点击「换一批 🔄」随时探索新课文，防止信息过载）；
* **全套三位一体课件配置**：每篇课文均包含逐句双语对齐原文、核心语法要点深度拆解（如 Ser vs Estar、简单过去时、Por vs Para、虚拟式从句）以及阅读理解自测测验。
